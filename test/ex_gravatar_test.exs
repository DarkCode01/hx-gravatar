defmodule ExGravatarTest do
  ...
  test "picker color" do
    color = ExGravatar.picker_color()

    assert is_atom(color) == true
  end
  ...
  test "print element" do
    element_color = ExGravatar.print_element(true, :red)
    element_without_color = ExGravatar.print_element(false, nil)

    assert element_without_color == "█"
